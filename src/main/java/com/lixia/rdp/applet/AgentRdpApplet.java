...
public class AgentRdpApplet extends Applet {
   ...
   AgentRdpThread rThread = null;
    ...
    public void start(){    
        ...
        rThread = new AgentRdpThread(args, this.getParameter("redirect_on_exit"), this);
        rThread.start();
    }
...
class AgentRdpThread extends Thread{
     
    String[] args;
    String redirect = null;
    Applet parentApplet = null;
    
    public AgentRdpThread(String[] args, String redirect, Applet a){
        parentApplet = a;
        this.args = args;
    ...
    public void run(){
        ...
        try {
        	//should start the app as a new application
