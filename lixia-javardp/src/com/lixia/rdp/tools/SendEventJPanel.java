...
public class SendEventJPanel extends JFrame {
	 ...
	 */
	public SendEventJPanel(RdpJPanel rdp) {
		super();
		initialize();
		this.rdp = rdp;
	}
		...
		if (jButton == null) {
			...
			jButton.addActionListener(new java.awt.event.ActionListener() { 
				public void actionPerformed(java.awt.event.ActionEvent e) {    
					if(rdp != null){
						rdp.sendInput(InputJPanel.getTime(),Integer.decode(inputTypeField.getText()).intValue(),Integer.decode(flagsField.getText()).intValue(),Integer.decode(param1Field.getText()).intValue(),Integer.decode(param2Field.getText()).intValue());
					}
				}
			});
		}
